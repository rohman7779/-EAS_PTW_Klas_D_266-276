        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer di rekening <strong>Bank BNI </strong></h6>
                    <h6><strong>Nomer Rekening : 0178305743</strong></h6>
                    <h6><strong>Atas Nama : Abdur Rohman</strong></h6>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ url('assets/bunga') }}/{{ $pesanan_detail->barang->gambar }}" width="100" alt="...">
                                </td>
